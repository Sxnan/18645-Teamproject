...
00000000000008e0 <_start>:
     ...
     8ed:	50                   	push   %rax
     8ee:	54                   	push   %rsp
     8ef:	4c 8d 05 da b2 00 00 	lea    0xb2da(%rip),%r8        # bbd0 <__libc_csu_fini>
     8f6:	48 8d 0d 63 b2 00 00 	lea    0xb263(%rip),%rcx        # bb60 <__libc_csu_init>
...
0000000000000910 <__gmon_start__>:
     ...
     92b:	48 8d 35 c7 b2 00 00 	lea    0xb2c7(%rip),%rsi        # bbf9 <etext>
     ...
     94c:	e9 8f b2 00 00       	jmpq   bbe0 <atexit>
...
0000000000000a8e <main>:
     ...
     b18:	e8 21 b0 00 00       	callq  bb3e <_Z5rdtscv>
    ...
    b704:	e8 35 04 00 00       	callq  bb3e <_Z5rdtscv>
    b709:	48 89 85 28 ed df ff 	mov    %rax,-0x2012d8(%rbp)
    b710:	48 8d 35 f1 04 00 00 	lea    0x4f1(%rip),%rsi        # bc08 <_ZL11MAXHEAPSIZE+0x4>
...
000000000000b7ce <_Z4swapPP4GridS1_>:
    ...
    b7d2:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
    b7d6:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
    b7da:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    b7de:	48 8b 00             	mov    (%rax),%rax
    b7e1:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    b7e5:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    b7e9:	48 8b 10             	mov    (%rax),%rdx
    b7ec:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    b7f0:	48 89 10             	mov    %rdx,(%rax)
    b7f3:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    b7f7:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    b7fb:	48 89 10             	mov    %rdx,(%rax)
    b7fe:	90                   	nop
    b7ff:	5d                   	pop    %rbp
    b800:	c3                   	retq   
    b801:	90                   	nop
...
000000000000b83e <_ZN4Heap4pushEP4Grid>:
    ...
    b846:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
    b84a:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
    b84e:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    b852:	8b 80 00 00 20 00    	mov    0x200000(%rax),%eax
    b858:	8d 50 01             	lea    0x1(%rax),%edx
    b85b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    b85f:	89 90 00 00 20 00    	mov    %edx,0x200000(%rax)
    b865:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    b869:	8b 90 00 00 20 00    	mov    0x200000(%rax),%edx
    b86f:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    b873:	48 63 d2             	movslq %edx,%rdx
    b876:	48 8b 4d f0          	mov    -0x10(%rbp),%rcx
    b87a:	48 89 0c d0          	mov    %rcx,(%rax,%rdx,8)
    b87e:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
...
000000000000b88e <_ZN4Heap10heapify_upEv>:
    ...
    b8b5:	8b 55 fc             	mov    -0x4(%rbp),%edx
    b8b8:	48 63 d2             	movslq %edx,%rdx
    b8bb:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
    b8bf:	8b 48 04             	mov    0x4(%rax),%ecx
    b8c2:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
...
000000000000b974 <_ZN4Heap3popEv>:
    ...
    b97c:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
    b980:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    b984:	8b 80 00 00 20 00    	mov    0x200000(%rax),%eax
    b98a:	8d 48 ff             	lea    -0x1(%rax),%ecx
    b98d:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    b991:	89 8a 00 00 20 00    	mov    %ecx,0x200000(%rdx)
    b997:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    b99b:	48 98                	cltq   
    b99d:	48 8b 14 c2          	mov    (%rdx,%rax,8),%rdx
    b9a1:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    b9a5:	48 89 50 08          	mov    %rdx,0x8(%rax)
    b9a9:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    b9ad:	48 89 c7             	mov    %rax,%rdi
    b9b0:	e8 87 00 00 00       	callq  ba3c <_ZN4Heap12heapify_downEv>
    b9b5:	90                   	nop
    b9b6:	c9                   	leaveq 
    b9b7:	c3                   	retq   

000000000000b9b8 <_Z14find_min_childP4Heapii>:
    b9b8:	55                   	push   %rbp
    b9b9:	48 89 e5             	mov    %rsp,%rbp
    b9bc:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
    b9c0:	89 75 e4             	mov    %esi,-0x1c(%rbp)
    b9c3:	89 55 e0             	mov    %edx,-0x20(%rbp)
    b9c6:	c7 45 f4 a0 86 01 00 	movl   $0x186a0,-0xc(%rbp)
    b9cd:	c7 45 fc ff ff ff ff 	movl   $0xffffffff,-0x4(%rbp)
    b9d4:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    b9db:	8b 45 f8             	mov    -0x8(%rbp),%eax
    b9de:	3b 45 e0             	cmp    -0x20(%rbp),%eax

    
    b9e1:	7d 56                	jge    ba39 <_Z14find_min_childP4Heapii+0x81>
    b9e3:	8b 55 e4             	mov    -0x1c(%rbp),%edx
    b9e6:	8b 45 f8             	mov    -0x8(%rbp),%eax
    b9e9:	01 c2                	add    %eax,%edx
    b9eb:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    b9ef:	8b 80 00 00 20 00    	mov    0x200000(%rax),%eax
    b9f5:	39 c2                	cmp    %eax,%edx
    b9f7:	7f 3a                	jg     ba33 <_Z14find_min_childP4Heapii+0x7b>
    b9f9:	8b 55 e4             	mov    -0x1c(%rbp),%edx
    b9fc:	8b 45 f8             	mov    -0x8(%rbp),%eax
    b9ff:	01 c2                	add    %eax,%edx
    ba01:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    ba05:	48 63 d2             	movslq %edx,%rdx
    ba08:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
    ba0c:	8b 40 04             	mov    0x4(%rax),%eax
    ba0f:	39 45 f4             	cmp    %eax,-0xc(%rbp)
    ba12:	7e 1f                	jle    ba33 <_Z14find_min_childP4Heapii+0x7b>
    ba14:	8b 55 e4             	mov    -0x1c(%rbp),%edx
    ba17:	8b 45 f8             	mov    -0x8(%rbp),%eax
    ba1a:	01 c2                	add    %eax,%edx
    ba1c:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    ba20:	48 63 d2             	movslq %edx,%rdx
    ba23:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
    ba27:	8b 40 04             	mov    0x4(%rax),%eax
    ba2a:	89 45 f4             	mov    %eax,-0xc(%rbp)
    ba2d:	8b 45 f8             	mov    -0x8(%rbp),%eax
    ba30:	89 45 fc             	mov    %eax,-0x4(%rbp)
    ba33:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    ba37:	eb a2                	jmp    b9db <_Z14find_min_childP4Heapii+0x23>
...
000000000000ba3c <_ZN4Heap12heapify_downEv>:
    ba3c:	55                   	push   %rbp
    ba3d:	48 89 e5             	mov    %rsp,%rbp
    ba40:	48 83 ec 18          	sub    $0x18,%rsp
    ba44:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
    ba48:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%rbp)
    ba4f:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    ba53:	8b 80 04 00 20 00    	mov    0x200004(%rax),%eax
    ba59:	0f af 45 f8          	imul   -0x8(%rbp),%eax
    ba5d:	89 c2                	mov    %eax,%edx
    ba5f:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    ba63:	8b 80 04 00 20 00    	mov    0x200004(%rax),%eax
    ba69:	83 e8 02             	sub    $0x2,%eax
    ba6c:	29 c2                	sub    %eax,%edx
    ba6e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    ba72:	8b 80 00 00 20 00    	mov    0x200000(%rax),%eax
    ba78:	39 c2                	cmp    %eax,%edx
    ba7a:	0f 8f a8 00 00 00    	jg     bb28 <_ZN4Heap12heapify_downEv+0xec>
    ba80:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    ba84:	8b 80 04 00 20 00    	mov    0x200004(%rax),%eax
    ba8a:	0f af 45 f8          	imul   -0x8(%rbp),%eax
    ba8e:	89 c2                	mov    %eax,%edx
    ba90:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    ba94:	8b 80 04 00 20 00    	mov    0x200004(%rax),%eax
    ba9a:	83 e8 02             	sub    $0x2,%eax
    ba9d:	29 c2                	sub    %eax,%edx
    ba9f:	89 d0                	mov    %edx,%eax
    baa1:	89 45 fc             	mov    %eax,-0x4(%rbp)
    baa4:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    baa8:	8b 90 04 00 20 00    	mov    0x200004(%rax),%edx
    baae:	8b 4d fc             	mov    -0x4(%rbp),%ecx
    bab1:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    bab5:	89 ce                	mov    %ecx,%esi
    bab7:	48 89 c7             	mov    %rax,%rdi
    baba:	e8 f9 fe ff ff       	callq  b9b8 <_Z14find_min_childP4Heapii>
    babf:	01 45 fc             	add    %eax,-0x4(%rbp)
    bac2:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    bac6:	8b 55 f8             	mov    -0x8(%rbp),%edx
    bac9:	48 63 d2             	movslq %edx,%rdx
    bacc:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
    bad0:	8b 48 04             	mov    0x4(%rax),%ecx
    bad3:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    bad7:	8b 55 fc             	mov    -0x4(%rbp),%edx
    bada:	48 63 d2             	movslq %edx,%rdx
    badd:	48 8b 04 d0          	mov    (%rax,%rdx,8),%rax
    bae1:	8b 40 04             	mov    0x4(%rax),%eax
    bae4:	39 c1                	cmp    %eax,%ecx
    bae6:	7e 3e                	jle    bb26 <_ZN4Heap12heapify_downEv+0xea>
    bae8:	8b 45 fc             	mov    -0x4(%rbp),%eax
    baeb:	48 98                	cltq   
    baed:	48 8d 14 c5 00 00 00 	lea    0x0(,%rax,8),%rdx
    baf4:	00 
    baf5:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    baf9:	48 01 c2             	add    %rax,%rdx
    bafc:	8b 45 f8             	mov    -0x8(%rbp),%eax
    baff:	48 98                	cltq   
    bb01:	48 8d 0c c5 00 00 00 	lea    0x0(,%rax,8),%rcx
    bb08:	00 
    bb09:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    bb0d:	48 01 c8             	add    %rcx,%rax
    bb10:	48 89 d6             	mov    %rdx,%rsi
    bb13:	48 89 c7             	mov    %rax,%rdi
    bb16:	e8 b3 fc ff ff       	callq  b7ce <_Z4swapPP4GridS1_>
    bb1b:	8b 45 fc             	mov    -0x4(%rbp),%eax
    bb1e:	89 45 f8             	mov    %eax,-0x8(%rbp)
    bb21:	e9 29 ff ff ff       	jmpq   ba4f <_ZN4Heap12heapify_downEv+0x13>
    bb26:	90                   	nop
    bb27:	90                   	nop
    bb28:	90                   	nop
    bb29:	c9                   	leaveq 
...
000000000000bb2c <_ZN4Heap3topEv>:
    bb2c:	55                   	push   %rbp
    bb2d:	48 89 e5             	mov    %rsp,%rbp
    bb30:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
    bb34:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    bb38:	48 8b 40 08          	mov    0x8(%rax),%rax
    bb3c:	5d                   	pop    %rbp
    bb3d:	c3                   	retq   

000000000000bb3e <_Z5rdtscv>:
    bb3e:	55                   	push   %rbp
    bb3f:	48 89 e5             	mov    %rsp,%rbp
    bb42:	0f 31                	rdtsc  
    bb44:	89 45 f8             	mov    %eax,-0x8(%rbp)
    bb47:	89 55 fc             	mov    %edx,-0x4(%rbp)
    bb4a:	8b 45 f8             	mov    -0x8(%rbp),%eax
    bb4d:	8b 55 fc             	mov    -0x4(%rbp),%edx
    bb50:	48 c1 e2 20          	shl    $0x20,%rdx
    bb54:	48 09 d0             	or     %rdx,%rax
    bb57:	5d                   	pop    %rbp
    bb58:	c3                   	retq   
    bb59:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)

000000000000bb60 <__libc_csu_init>:
    bb60:	41 57                	push   %r15
    bb62:	41 56                	push   %r14
    bb64:	49 89 d7             	mov    %rdx,%r15
    bb67:	41 55                	push   %r13
    bb69:	41 54                	push   %r12
    bb6b:	4c 8d 25 ee 11 20 00 	lea    0x2011ee(%rip),%r12        # 20cd60 <__frame_dummy_init_array_entry>
    bb72:	55                   	push   %rbp
    bb73:	48 8d 2d f6 11 20 00 	lea    0x2011f6(%rip),%rbp        # 20cd70 <__init_array_end>
    bb7a:	53                   	push   %rbx
    bb7b:	41 89 fd             	mov    %edi,%r13d
    bb7e:	49 89 f6             	mov    %rsi,%r14
    bb81:	4c 29 e5             	sub    %r12,%rbp
    bb84:	48 83 ec 08          	sub    $0x8,%rsp
    bb88:	48 c1 fd 03          	sar    $0x3,%rbp
    bb8c:	e8 a7 4c ff ff       	callq  838 <_init>
    bb91:	48 85 ed             	test   %rbp,%rbp
    bb94:	74 20                	je     bbb6 <__libc_csu_init+0x56>
    bb96:	31 db                	xor    %ebx,%ebx
    bb98:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    bb9f:	00 
    bba0:	4c 89 fa             	mov    %r15,%rdx
    bba3:	4c 89 f6             	mov    %r14,%rsi
    bba6:	44 89 ef             	mov    %r13d,%edi
    bba9:	41 ff 14 dc          	callq  *(%r12,%rbx,8)
    bbad:	48 83 c3 01          	add    $0x1,%rbx
    bbb1:	48 39 dd             	cmp    %rbx,%rbp
    bbb4:	75 ea                	jne    bba0 <__libc_csu_init+0x40>
    bbb6:	48 83 c4 08          	add    $0x8,%rsp
    bbba:	5b                   	pop    %rbx
    bbbb:	5d                   	pop    %rbp
    bbbc:	41 5c                	pop    %r12
    bbbe:	41 5d                	pop    %r13
    ...
    bbc4:	c3                   	retq   
    bbc5:	90                   	nop
    bbc6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    bbcd:	00 00 00 

000000000000bbd0 <__libc_csu_fini>:
    bbd0:	f3 c3                	repz retq 
    bbd2:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    bbd9:	00 00 00 
    bbdc:	0f 1f 40 00          	nopl   0x0(%rax)

000000000000bbe0 <atexit>:
    bbe0:	48 8b 15 21 14 20 00 	mov    0x201421(%rip),%rdx        # 20d008 <__dso_handle>
    bbe7:	31 f6                	xor    %esi,%esi
    bbe9:	e9 72 4c ff ff       	jmpq   860 <__cxa_atexit@plt>

Disassembly of section .fini:

000000000000bbf0 <_fini>:
    bbf0:	48 83 ec 08          	sub    $0x8,%rsp
    bbf4:	48 83 c4 08          	add    $0x8,%rsp
    bbf8:	c3                   	retq   
